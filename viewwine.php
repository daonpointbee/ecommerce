...
<html>
	<head>
		...
		echo	"<tr>";
		echo	"<td>Wine Name</td><td>Winery</td><td>Quantity</td><td>Price</td><td>Region</td><td>Image</td>";
		echo	"</tr>";
		echo "<ol>";
		$var1_row=$var1->fetch();
		while ($var1_row) {
				...
				echo "<td>{$var1_row['region_name']}</td>";
				echo "<td><img src=wine/".$var1_row['image']."></td></tr>";
				$var1_row=$var1->fetch();
		}
		echo "</ol>";
		echo "</table>";
